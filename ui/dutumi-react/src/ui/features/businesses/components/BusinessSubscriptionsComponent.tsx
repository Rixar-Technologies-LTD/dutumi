...
const BusinessSubscriptionsComponent = ({ business  } : BranchesProps) => {
    ...
    return <>
        <Card className="good-shadow" title={<>
            ...
            <Button icon={<PlusCircleFilled/>} style={{ margin:'0px 24px'}} onClick={showNewSubscriptionForm} type="primary">Add Subscription</Button>
        </>}>
...
export default BusinessSubscriptionsComponent;
